...
public class SFLoginPage extends BaseClass{
	...
	public void verifyLoginPage() throws InterruptedException {
		...
		Thread.sleep(5000);
		Action.type(userName, "jagadeeshteja7860@CTS.com");
		Action.type(password, "Testing*12345");
...
public SFHomePage LoginSFMoveHomePage() throws InterruptedException {
		
		Thread.sleep(5000);
		Action.type(userName, "jagadeeshteja@CTS.com");
		Action.type(password, "Testing*12345");
		Action.switchToFrameByName(driver, "marketing");
		//Action.switchToFrameById(driver, "marketing");
		Thread.sleep(2000);
